    ...
    if(contenedor){
        if (menu.length > 0){
            ...
            if(titulo != "" && titulo != null){
                ...
                alert("No se ha registrado ningun titulo, por favor ingrese la información.");
            }
        } else{
            alert("Debe agregar un menu primero");
        }
    } else{
        alert("Primero debe agregar un contenedor de una pagina");
    }
};
    ...
    if(contenedor){
        if(menu.length >0){
            ...
            if(texto != "" && texto != null){
                ...
                alert("No se ha registrado ningun parrafo, por favor ingrese la información.");
            }
        } else{
            alert("Debe agregar un menu primero.");
        }
